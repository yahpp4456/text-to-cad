...
- each end: a 4-module rack stack, heights bottom-up 11.5 / 11.5 / 16.5 / 11.5
  ...
  recesses / corner R1) -- screw direction screw_from_top=1 (countersinks on
  module tops, nut pockets on bottoms, measured on BOTH Y stacks; customer
  confirmed this is the as-installed orientation for X too -- the X OEM STEP
  models its screws inverted); half volumes reproduce the OEM solids
...
# (固定架模組細節常數全在那;screw_from_top=1 = 實裝方向:六角袋朝下,兩端量測
# 皆同,客戶確認 OK——X 的 OEM STEP 反了,以本檔為實裝參考)。
